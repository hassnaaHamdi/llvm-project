...
class LoopVectorizationPlanner {
  ...
  /// been retired.
  InstructionCost cost(VPlan &Plan, ElementCount VF, VPRegisterUsage *RU, LoopVectorizationCostModel &EnabledCM) const;
...
public:
  ...
  bool planForEpilogueTF(ElementCount UserVF, unsigned UserIC, ElementCount EpilogueUserVF, LoopVectorizationCostModel &EpilogueCM);
...
private:
  ...
  VPlanPtr tryToBuildVPlan(VPlanPtr InitialPlan, VFRange &Range, LoopVectorizationCostModel &EnabledCM);
